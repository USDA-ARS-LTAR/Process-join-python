...
try:
    # Local variables...
    locationName = "NELITCSE"
    diskLocation="C:/mapdocumentsGPSR/NUOnet/"+locationName+"/"     
        ...
        if sheet == "WeatherDaily": #ok
            ...
            for fc in fcs:
                for i in range(0, len(fld2Base)):                
                    ...
                    arcpy.CalculateField_management(fc,fld2New[i],"["+fld2Base[i]+"]")
                    arcpy.DeleteField_management(fc, fld2Base[i])
        elif sheet == "FieldSites": #ok
            fld2Base = ["Latitude_d","Longitude","Spatial_De","Elevation","MAP_mm","MAT_degC","Native_Veg","Site_Histo"]
            fld2New  = ["Latitude_d_1","Longitude_1","Spatial_De_1","Elevation_1","MAP_mm_1","MAT_degC_1","Native_Veg_1","Site_Histo_1"]
            for fc in fcs:
                for i in range(0, len(fld2Base)):
                    if (fld2Base[i] == "Spatial_De") or (fld2Base[i] == "Native_Veg") or (fld2Base[i] == "Site_Histo"):
                        arcpy.AddField_management(fc,fld2New[i], "Text", "", "", "", fld2New[i], "NULLABLE", "NON_REQUIRED")
                    else:
                        arcpy.AddField_management(fc,fld2New[i], "Double", "", "", "", fld2New[i], "NULLABLE", "NON_REQUIRED")         
                    arcpy.CalculateField_management(fc,fld2New[i],"["+fld2Base[i]+"]")
            ...
            #fld2Base = ["Corn_Ear_H","Above_G_Bi","Unit_Grain","Grain_Dry","Grain_Mois","Grain_C_kg","Grain_N_kg","Harv_NonGr","Harv_Res_M","Harv_Res_C","Harv_Res_N","NonHarv_No","NonHarv_Re","NonHarv__1","NonHarv__2","Root_Dry_M","Root_Moist","Root_C_kgC","Root_N_kgN","Corn_Ear_1","Above_G__1","Unit_Gra_1","Grain_Dr_1","Grain_Mo_1","Grain_C_ST","Grain_N_ST","Harv_Non_1","Harv_Res_1","Harv_Res_2","Harv_Res_3","NonHarv__3","NonHarv__4","NonHarv__5","NonHarv__6","Root_Dry_1","Root_Moi_1","Root_C_STD","Root_N_STD"]
            #fld2New = ["Corn_Ear_Height_cm","Above_G_Biomass_kg_ha","Unit_Grain_Weight_mg","Grain_Dry_Matt_kg_ha","Grain_Moist__","Grain_C_kgC_ha","Grain_N_kgN_ha","Harv_NonGrain_Bio_kg_ha","Harv_Res_Moist__","Harv_Res_C_kgC_ha","Harv_Res_N_kgN_ha","NonHarv_NonGrain_Bio_kg_ha","NonHarv_Res_Moist__","NonHarv_Res_C_kgC_ha","NonHarv_Res_N_kgN_ha","Root_Dry_Matt_kg_ha","Root_Moist__","Root_C_kgC_ha","Root_N_kgN_ha","Corn_Ear_Height_STD_cm","Above_G_Biomass_STD_kg_ha","Unit_Grain_Weight_STD_mg","Grain_Dry_Matt_STD_kg_ha","Grain_Moist_STD__","Grain_C_STD_kgC_ha","Grain_N_STD_kgN_ha","Harv_NonGrain_Bio_STD_kg_ha","Harv_Res_Moist_STD__","Harv_Res_C_STD_kgC_ha","Harv_Res_N_STD_kgN_ha","NonHarv_NonGrain_Bio_STD_kg_ha","NonHarv_Res_Moist_STD__","NonHarv_Res_C_STD_kgC_ha","NonHarv_Res_N_STD_kgN_ha","Root_Dry_Matt_STD_kg_ha","Root_Moist_STD__","Root_C_STD_kgC_ha","Root_N_STD_kgN_ha"]            
            for fc in fcs:
                for i in range(0, len(fld2Base)):            
                    arcpy.AddField_management(fc,fld2New[i], "Double", "", "", "", fld2New[i], "NULLABLE", "NON_REQUIRED")         
                    arcpy.CalculateField_management(fc,fld2New[i],"["+fld2Base[i]+"]")
            ...
            fld2Base = ["Frac_Dry_M","Frac_Moist","Frac_C_kgC","Frac_N_kgN","Grain_Weig","Frac_Dry_1","Frac_Moi_1","Frac_C_STD","Frac_N_STD","Grain_We_1"]
            fld2New  = ["Frac_Dry_M_1","Frac_Moist_1","Frac_C_kgC_1","Frac_N_kgN_1","Grain_Weig_1","Frac_Dry_1_1","Frac_Moi_1_1","Frac_C_STD_1","Frac_N_STD_1","Grain_We_1_1"]
            for fc in fcs:
                for i in range(0, len(fld2Base)):            
                    arcpy.AddField_management(fc,fld2New[i], "Double", "", "", "", fld2New[i], "NULLABLE", "NON_REQUIRED")         
                    arcpy.CalculateField_management(fc,fld2New[i],"["+fld2Base[i]+"]")
            ...
            for fc in fcs:
                for i in range(0, len(fld2Base)):
                    if (fld2Base[i] == "Chemical_C") or (fld2Base[i] == "Units"):
                        arcpy.AddField_management(fc,fld2New[i], "Text", "", "", "", fld2New[i], "NULLABLE", "NON_REQUIRED")                                  
                    else:
                        arcpy.AddField_management(fc,fld2New[i], "Double", "", "", "", fld2New[i], "NULLABLE", "NON_REQUIRED")         
                    arcpy.CalculateField_management(fc,fld2New[i],"["+fld2Base[i]+"]")
            ...
            for fc in fcs:
                for i in range(0, len(fld2Base)):
                    ...
                    arcpy.CalculateField_management(fc,fld2New[i],"["+fld2Base[i]+"]")
                    arcpy.DeleteField_management(fc, fld2Base[i])
        elif sheet == "MeasYieldNutUptake": # test
